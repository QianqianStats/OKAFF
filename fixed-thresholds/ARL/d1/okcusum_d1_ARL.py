...
def estimate_rl_moments_h0_okcusum_tau(
    tau: float,
    *,
    d: int,
    ref_size: int,
...
if __name__ == "__main__":
    ...
    # arl from 100-1300
    thresholds = [3.3, 4.5, 5.3]
    # full arl from 100-20000
    # thresholds = [3.3, 4.0, 5.5, 6.0, 6.2, 6.5, 7.0, 7.3, 7.4]
    ...
    for tau in thresholds:
        metrics = estimate_rl_moments_h0_okcusum_tau(
            tau,
            d=d,
            ref_size=ref_size,
    ...
    print("\nFinal summary:")
    print(df[["threshold", "ARL_hat", "ARL_se_hat", "censored_rate", "detector"]])

    out_csv = out_dir / f"okcusum-ARL-d{d}-nrun{n_runs}.csv"
